    ...
    export default {
        ...
        methods: {
            ...
            checkExist(theName,theValue){
                ...
                postTokenData(base.basePath + '/devPlan/checkSave',{yearAndMonth:theValue}, (res)=>{
                    if (res.success) {
                        if (!res.data){
                            let setBase = ()=>{
            ...
            getBudgeNumber(ymData){
                postTokenData(base.basePath + '/devPlan/getPredictNum',{yearAndMonth:ymData}, (res)=>{
                    if (res.success) {
                        this.budgeNumber = res.data.predictNum;
                    } else {
                        Toast({message: res.message, iconClass: 'mintui mintui-field-error'})
                    }
                });
            ...
            saveMonthPlan(){
                ...
                postTokenData(base.basePath + '/devPlan/add',postParam, {
                    success: (res)=> {
                        if (res.success) {
