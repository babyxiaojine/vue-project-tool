                ...
                <ul class="clearfix">
                    <li v-for="(item,index) in reqObjPointTraceParams" :key="index">
                        <div class="tl-dir bdtop">
                            <div class="td-title">
                                <em>{{item.objName || item.shopName}}<i v-if="!item.editFlag" class="within-plan"></i></em>
                        ...
                        <div class="tl-cont row-list bdtb">
                            <div class="row-list-item">
                                ...
                                <div class="cell-value">{{targetStatus(item.objStatus)}}</div>
                            </div>
            ...
            <div class="target-list" v-show="tabIndex == 5">
                <ul class="clearfix">
                    <li v-for="(item,index) in reqBrandAddParams" :key="index">
                        ...
                        <div class="tl-cont row-list bdtb">
                            <div class="row-list-item" @click="item.editFlag && selectItemOption({index:index,filed:'reqBrandAddParams',name:'projectName',brand:item.brandName})">
  ...
  export default {
    ...
    methods: {
      ...
      changeItemOption(val,param){
        // console.log(val,param,'123123123');
        ...
        if (iName == 'projectName'){//品牌信息
          // let brand = this[iFiled][iIndex][iName];
